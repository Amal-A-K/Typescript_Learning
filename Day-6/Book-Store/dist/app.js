...
//             Book Data Setup
// ==========================================
const bookStore = new ArrayWrapper();
 ...
 */
function displayMessage(elementId, message, type, clearAfterMs) {
...
function addInputListenersToClearMessage(elementIds, messageElementId) {
