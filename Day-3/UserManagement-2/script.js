...
//Role validation
function roleValidation(roleValue) {
...
form.addEventListener('submit', (e) => {
    ...
    const ageInp = form.elements.namedItem('age');
    ...
    // Create and add user
    const newUser = Object.assign(Object.assign({ id: users.length + 1, name,
        email }, (age && { age })), (role && { role }));
    users.push(newUser);
    renderUsers();
    form.reset();
});
